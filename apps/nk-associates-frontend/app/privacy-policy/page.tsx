  ...
  return (
    <div className="block pb-[2rem] md:pb-[6.25rem] px-[2rem] md:px-[6.25rem] text-nk-dark-gray container">
      ...
      <p className="font-metropolis text-base mb-6 text-[0.875rem] md:text-[1.25rem]">
        ...
        aggregated with all other user data. <br className="pb-1" /> <br />
        ...
        <br className="pb-1" /> <br /> We use both session cookies (which are
      ...
      <p className="font-metropolis text-base mb-6 text-[0.875rem] md:text-[1.25rem]">
        ...
        your identity and ensure the confidentiality of your data. <br /> <br />
