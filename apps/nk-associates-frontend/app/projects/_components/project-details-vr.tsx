...
const ProjectDetailsVR = () => {
  return (
    <section className="relative h-[16.625rem] sm:h-[25.625rem] md:h-[32.625rem] bg-red-300 bg-cover [background-image:url('/assets/images/bg-project.jpeg')] xl:h-[39.375rem] lg:min-h-[35.375rem]">
