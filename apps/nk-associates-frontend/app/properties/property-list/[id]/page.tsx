...
async function PropertyDetail({ params: { id } }) {
  ...
  const center = { lat: 33.49328003537904, lng: 73.10087489838429 };
const locations  = [{lat: 33.55427247854852, lng: 73.09534453163067}, {lat:33.54949268301728, lng: 73.12385803665302}, {lat:33.52258019226873, lng:73.0887855231596}, {lat: 33.650024870838685, lng: 73.04176688268879}]
  return (
    <section className="">
      <DetailSlider />
