...
const footer = () => {
	return (
		<footer className="min-h-fit bg-nk-dark-gray font-metropolis dark:text-nk-white ">
					...
					<div className="md:flex md:justify-between">
						...
						<div className="grid grid-cols-2 p-1 sm:m-1 sm:grid-cols-4 sm:gap-4 lg:px-16 xl:px-24 2xl:px-36">
							<div className="text-lg">
								<h2 className="mb-2 font-metropolis-bold text-base tracking-widest dark:text-nk-white	md:font-metropolis-medium ">
									COMPANY
								</h2>
								<ul>
									<li className="mb-3">
							...
							<div className="hidden font-metropolis-medium text-base md:block ">
								<h2 className="mb-2 text-base tracking-widest dark:text-nk-white 	">
									DOWNLOAD
								</h2>
								<div>
									<ul>
							...
							<div className="hidden md:block ">
								<h2 className="mb-2 text-base tracking-widest dark:text-nk-white md:font-metropolis-medium	">
									SOCIAL
								</h2>
						...
						<div className="pt-4 sm:hidden">
							...
							<div>
								<div className="text-base ">
									<h2 className="m-2 flex justify-center font-metropolis-medium text-sm tracking-widest dark:text-nk-white	">
										DOWNLOAD
									</h2>
									<div className="flex justify-center ">
