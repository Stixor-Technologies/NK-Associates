...
const SearchBar: FC<SearBarProps> = ({ onFilter, actHome = false }) => {
  ...
  return (
    <section className="container relative my-4 flex flex-col">
      ...
      <div className="hidden md:flex my-6 flex-wrap justify-center gap-0.5 overflow-hidden rounded-xl w-full shadow-3xl">
