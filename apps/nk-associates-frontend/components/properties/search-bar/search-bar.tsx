...
const SearchBar: FC<SearchBarProps> = ({
  ...
  return (
    <section className="relative">
      <div className={`container flex flex-col ${isListView && "my-4"}`}>
        <div
        ...
        <div
          className={`hidden md:flex flex-wrap justify-center overflow-hidden w-full shadow-3xl ${
        ...
        >
          ...
          {actHome ? (
            <div className="min-w-fit flex-1 flex-grow-[2.5] flex items-center justify-end bg-white">
              <LinkButton
                text="Search"
                type="solid"
                clickEvent={handleSearchHome}
                className="w-[90%] h-[65%]"
              />
            </div>
          ) : (
