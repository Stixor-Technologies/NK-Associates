      ...
      >
        ...
        <div className="flex flex-col gap-6 md:flex-row md:gap-0 md:items-center">
          ...
          >
            {!actHome && (
              <button
                className="min-w-[119px] hidden md:flex items-center justify-center bg-white hover:text-nk-red rounded-full px-5 py-1.5 cursor-pointer shadow-3xl"
                onClick={() => setOpenFilter(true)}
              >
                Filters
                <svg
            ...
            {filtersState?.filterIsSelected && !actHome && (
              <button
                className={`min-w-[153px] flex items-center justify-center bg-white hover:text-nk-red rounded-full px-5 py-1.5 cursor-pointer shadow-3xl transition-colors ${
